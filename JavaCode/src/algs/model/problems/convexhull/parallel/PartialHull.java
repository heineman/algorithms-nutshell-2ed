...
public class PartialHull {
	 ...
	 * @return true if was able to remove the designated point. 
	 */
	 ...
	 * @return true if more than 2 points currently in hull; false otherwise. 
	 */
	 ...
	 * @return size of the partial hull. 
	 */
	public int size() { 
		return points.size();
	}
	 ...
	 * 
	 * @return true if last three points reflect a right turn; false otherwise. If hasThree() is false, then this returns false.
	 */
	 ...
	 * @return          index position after final entry.
	 */
