...
plot '2ed-table2-4.dat' using 1:3 index 0 title "mult" smooth csplines with lines,'2ed-table2-4.dat' using 1:4 index 0 title "times" smooth csplines with lines
