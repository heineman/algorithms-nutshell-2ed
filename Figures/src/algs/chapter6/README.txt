...
Figure 6-1: Graph Examples

  TBD: Add better examples!
...
Table 6-3: Time (in seconds) to compute single source shortest path on dense graphs [Makefile]
...
Figure 6-16: Prim's Algorithm fact sheet
