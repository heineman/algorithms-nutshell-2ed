...
/**
 * Compute performance savings on using Akl-Toussaint heuristic using points drawn
 * uniformly from Unit Circle. 
 *
 * This material adds a sentence after Table 9-2 in the book.
 */
public class CirclePoints { 
	...
	public static void main (String []args) {
		...
		Generator<IPoint> g = new UniformCircleGenerator();
