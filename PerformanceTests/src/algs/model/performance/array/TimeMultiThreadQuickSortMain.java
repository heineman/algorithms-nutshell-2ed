...
public class TimeMultiThreadQuickSortMain  {
	
	int BASE = 16777216;
	int numThreads;

	TimeMultiThreadQuickSortMain (int nt) {
		numThreads = nt;
	}
	...
	public static void main(String[] args) {
		for (int nt = 1; nt<= 10; nt++) {
			...
			new TimeMultiThreadQuickSortMain(nt).testQS();
		}
	}
	...
	public void testQS() {
		...
		for (int size = 10; size <= 1000000; size *= 10) {
			...
			for (int t = 0; t < 20; t++) {
				// create random arrays of given SIZE 
