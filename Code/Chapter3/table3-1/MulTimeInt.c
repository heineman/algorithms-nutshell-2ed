/**
 * @file MulTimeInt.c    Task to create two int numbers for muliplication.
 * @brief 
 *    Execute for a fixed number of iterations the multiplication of two random int numbers.
 * 
