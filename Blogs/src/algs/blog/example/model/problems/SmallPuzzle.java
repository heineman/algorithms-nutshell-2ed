...
/**
 * Minimal problem for pseudo-code in book chapters.
 * <p>
 ...
 * @since 1.0
 */
public class SmallPuzzle implements INode, Comparable<SmallPuzzle> {
	...
	public boolean equals(Object o) {
		...
		if (o instanceof SmallPuzzle) {
			SmallPuzzle tp = (SmallPuzzle) o;
	...
	public DoubleLinkedList<IMove> validMoves() {
		...
		CutInHalfMove ch = new CutInHalfMove();
		if (ch.isValid(this)) {
			list.insert(ch);
		}
	...
	public int compareTo(SmallPuzzle tp) {
