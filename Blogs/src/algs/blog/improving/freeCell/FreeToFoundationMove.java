 ...
 * <p>
 * Unsure if this could lead to an automove. Just doing it.
 * @author George Heineman
 */
public class FreeToFoundationMove extends AutoMove {
	...
	public String toString () {
		String s = "move " + FreeCellNode.out(card) + " from free cell to foundation.";
		if (numAutoMoves() > 0) {
			return s + "[ " + numAutoMoves() + " auto moves]";
		}
