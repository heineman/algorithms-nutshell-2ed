 ...
 */
public class ColumnToColumnMove extends AutoMove {
	...
	public String toString () {
		String s = "move " + num + " cards based at " + FreeCellNode.out(card) + " from column " + fromCol + " to column " + toCol;
		if (numAutoMoves() > 0) {
