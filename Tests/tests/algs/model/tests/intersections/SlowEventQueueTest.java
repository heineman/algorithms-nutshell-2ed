...
import algs.model.problems.segmentIntersection.priorityqueue.SlowEventQueue;
import algs.model.twod.TwoDLineSegment;
import algs.model.twod.TwoDPoint;

public class SlowEventQueueTest extends TestCase {

	// make sure multiple inserted endpoints join their upper line segments so none are lost.
	@Test
	public void testInsert() {
		SlowEventQueue q = new SlowEventQueue();
